...
// Shown when the viewer has been blocked by the profile owner. Mirrors the
// "user not found" treatment (Instagram-style) rather than confirming a
// block exists — the placeholder handle keeps the real owner anonymous.
    ...
    >
      ...
      >
        ...
        <p className="text-sm leading-relaxed mb-8" style={{ color: 'var(--cr-text-muted)' }}>
          ...
          or the profile may no longer be reachable.
        </p>
